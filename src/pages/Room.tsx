      ...
      <main className="content">
        ...
        <form onSubmit={handleSendQuestion}>
          ...
          <div className="form-footer">
            ...
            {!user && <span>Para enviar uma pergunta, <button onClick={signInWithGoogle}>faça seu login</button>.</span>}
            {user && <div className="room-user-looged">
